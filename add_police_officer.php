			...
			<div class="card-body">
                ...
                <form method="post" action="http://localhost/DBMS%20Mini%20project/add_police_officer.php">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Officer ID<span style="color: red;"> *</span></label>
							<input type="text" name="officer_id"  class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Name<span style="color: red;"> *</span></label>
							<input type="text" name="officer_name"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">Batch Number<span style="color: red;"> *</span></label>
							<input type="text" name="officer_batch_number"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">Station ID<span style="color: red;"> *</span></label>
							<input type="text" name="officer_StationID"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">Phone Number<span style="color: red;"> *</span></label>
							<input type="text" name="Officer_Phone_no"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">Rank<span style="color: red;"> *</span></label>
							<input type="text" name="Officer_Rank"  class="form-control form-control-sm" id="exampleInputPassword1">
						</div>
						<button type="submit" name="police_details_add_button" class="btn btn-primary btn-block">Add</button>
                    </form>
				</div>
			</div>
		</div>
