    ...
    <div class="card login-form">
      <div class="card-body">
        ...
        <div class="card-text">
          ...
          <form method="post" action="http://localhost/DBMS%20Mini%20project/register.php">
            <?php include('errors.php'); ?>
            <a href="http://localhost/DBMS%20Mini%20project/login.php" style="float:right;font-size:12px;">Already have an account?</a>
            <!-- to error: add class "has-danger" -->
            <div class="form-group">
              <label for="exampleInputEmail1">Email<span style="color: red;"> *</span></label>

              <input type="email" name="email_ofuser" value=" <?php echo $email; ?>" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="password" name="Confirmed_password_ofuser" class="form-control form-control-sm" id="exampleInputPassword1">
            </div>
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Reffering Police Officer's Email<span style="color: red;"> *</span></label>
          <!-- <a href="#" style="float:right;font-size:12px;">Forgot password?</a> -->
          <input type="email" name="email_ofpoliceofficer" class="form-control form-control-sm" id="exampleInputPassword1">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Reffering Police Officer's Password<span style="color: red;"> *</span></label>
          <!-- <a href="C:\xampp\htdocs\DBMS Mini project\login.php" style="float:right;font-size:12px;">Already have an account?</a> -->
          <input type="password" name="password_ofpoliceofficer" class="form-control form-control-sm" id="exampleInputPassword1">
        </div>
        <button type="submit" name="register_button" class="btn btn-primary btn-block">Register</button>
