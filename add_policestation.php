...
<body style="background-color: #181818">
  ...
  <div style="margin-top: 120px;margin-bottom: 100px;" class="global-container">
		<div class="card login-form">
			<div class="card-body">
				<h3 class="card-title text-center">Police Station Details</h3>
				<div class="card-text">
                <form method="post" action="http://localhost/DBMS%20Mini%20project/add_policestation.php">
						<?php include('errors.php'); ?>
						<!-- to error: add class "has-danger" -->
						<div class="form-group">
							<label for="exampleInputEmail1">Station_Id<span style="color: red;"> *</span></label>
							<input type="text" name="station_id"  class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Name<span style="color: red;"> *</span></label>
							<input type="text" name="station_name"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">	Location<span style="color: red;"> *</span></label>
							<input type="text" name="station_location"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        
						<button type="submit" name="station_add_button" class="btn btn-primary btn-block">Add</button>
                    </form>
				</div>
			</div>
		</div>
