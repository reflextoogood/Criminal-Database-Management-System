			...
			<div class="card-body">
                ...
                <form method="post" action="http://localhost/DBMS%20Mini%20project/add_crimes.php">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Crime ID<span style="color: red;"> *</span></label>
							<input type="text" name="crime_id"  class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">Crime Category<span style="color: red;"> *</span></label>
							<input type="text" name="crime_category"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
							<label for="exampleInputPassword1">Section<span style="color: red;"> *</span></label>
							<input type="text" name="Section"  class="form-control form-control-sm" id="exampleInputPassword1">
                        </div>
                        
						<button type="submit" name="crime_details_add_button" class="btn btn-primary btn-block">Add</button>
                    </form>
				</div>
			</div>
		</div>
